...
def check_tradier_connection():
    ...
    try:
        from mawitek.data.tradier_client import get_account_balance, MOCK_MODE
    ...
    try:
        from mawitek.data.tradier_client import get_options_expirations, get_options_chain
    ...
    # Quote test
    try:
        from mawitek.data.tradier_client import get_quote
        price = get_quote("SPY")
        if price > 0:
...
def check_yfinance(quick: bool):
    ...
    # News
    try:
        from mawitek.data.news_catalyst import fetch_recent_news, _get_article_title, _get_publish_time
    ...
    # Earnings calendar
    try:
        from mawitek.data.earnings_filter import get_earnings_date
...
def check_unusual_whales(quick: bool):
    ...
    try:
        from mawitek.data.options_flow import get_bullish_sweep_tickers
