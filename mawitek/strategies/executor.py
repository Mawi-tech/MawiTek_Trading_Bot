        ...
        try:
            ...
            if not market_open:
                ...
                if _n.weekday() < 5 and _past_close:
                    try:
                        from mawitek.analysis.daily_report import maybe_send_eod_summary
